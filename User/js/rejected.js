    ...
    var user;
    var oid, ourl, oemail, olabel, otype, opage, ototal, odateo, odater, o, status;
    var j, list;

function rejectedOrder(u) {

    user = u;

    var dbref = firebase.database().ref().child('/UserOrders/' + user.uid + '/Rejected');
